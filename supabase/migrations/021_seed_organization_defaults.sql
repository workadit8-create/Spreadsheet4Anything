-- Seed data dasar untuk organisasi Premium Web (gudang, satuan, add-on).
-- Dipanggil dari scripts/onboard-premium-client.sql setelah INSERT organizations.
...
BEGIN
  ...
  FROM (VALUES ('project'), ('pos'), ('pos_gramasi'), ('crm')) AS k(addon_key)
