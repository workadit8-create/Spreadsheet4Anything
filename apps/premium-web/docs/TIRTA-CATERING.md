...
- Add-on **project**, **pos**, **pos_gramasi**, **crm** — aktif (gratis beta tester)
- Profil usaha: TIRTA CATERING, Tangerang

Aktifkan ulang / verifikasi:

```bash
./scripts/run-supabase-migration-file.sh enable-addons-tirta-catering.sql
```
