...
export default function PembelianPageClient() {
  return (
    <main className="mx-auto max-w-5xl px-6 py-8">
      <PageHeader
        badge="Pengeluaran · Pembelian"
        title="Pembelian"
        description="Supplier + kategori pembelian → PO → posting jurnal manual dari riwayat"
      >
      ...
      <Card>
        <h2 className="mb-4 text-base font-semibold text-slate-900">Buat pembelian</h2>
        <PembelianForm />
      </Card>
    </main>
  );
