...
export default function PiutangPageClient({ role }: { role: MembershipRole }) {
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-8">
      <PageHeader
        ...
        description={
          canPost
            ? "Invoice kredit / kurang bayar. Post jurnal = catat ke buku besar. Pelunasan (Bayar) dilakukan setelah jurnal penjualan diposting."
            : "Invoice kredit / kurang bayar. Catat pelunasan di sini; posting jurnal dilakukan akuntan atau owner."
        }
      />
