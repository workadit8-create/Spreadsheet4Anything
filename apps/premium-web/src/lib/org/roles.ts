...
const PATH_NAV_KEY: Array<{ prefix: string; key: NavKey }> = [
  ...
  { prefix: "/dashboard/inventory/products", key: "inventory-products" },
  { prefix: "/dashboard/inventory/product-categories", key: "inventory-product-categories" },
  { prefix: "/dashboard/inventory/suppliers", key: "inventory-suppliers" },
  { prefix: "/dashboard/inventory/outlets", key: "inventory-outlets" },
