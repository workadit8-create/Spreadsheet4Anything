...
export const PROJECT_TASK_TEMPLATES: Record<string, TaskTemplate> = {
  wedding: {
    ...
    items: [
      ...
      { phase: "Persiapan", title: "Purchase Request bahan (PR)", offsetDays: -7 },
      { phase: "Persiapan", title: "PO bahan — tag ke proyek", offsetDays: -5 },
  ...
  corporate: {
    ...
    items: [
      ...
      { phase: "Persiapan", title: "Purchase Request bahan", offsetDays: -5 },
      { phase: "Persiapan", title: "PO bahan — tag proyek", offsetDays: -3 },
